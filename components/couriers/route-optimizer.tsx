                ...
                <div className="h-[200px] relative rounded-md overflow-hidden">
                  ...
                  >
                    ...
                    <Polyline
                      ...
                      color={
                        selectedRoute?.id === route.id ? "#0ea5e9" : "#64748b"
                      }
                      weight={3}
                    />
                  </MapContainer>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <h3 className="font-semibold text-lg">
                  Optimized Route ({selectedRoute.name})
                </h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-muted/50 p-4 rounded-lg">
                    <p className="text-sm text-muted-foreground">Distance</p>
                    ...
                    <p className="text-sm text-green-600">
                      Save{" "}
                      {(
                        ((198.5 - selectedRoute.distance) / 198.5) *
                        100
                      ).toFixed(1)}
                      %
                    </p>
                  ...
                  <div className="bg-muted/50 p-4 rounded-lg">
                    <p className="text-sm text-muted-foreground">Duration</p>
                    <p className="text-xl font-bold text-green-600">
                      {(selectedRoute.duration / 60).toFixed(1)} hours
                    </p>
                    <p className="text-sm text-green-600">
                      Save{" "}
                      {(
                        ((4.2 - selectedRoute.duration / 60) / 4.2) *
                        100
                      ).toFixed(1)}
                      %
                    </p>
                  ...
                  <div className="bg-muted/50 p-4 rounded-lg">
                    <p className="text-sm text-muted-foreground">Fuel Cost</p>
                    <p className="text-xl font-bold text-green-600">
                      £{selectedRoute.fuelCost.toFixed(2)}
                    </p>
                    <p className="text-sm text-green-600">
          ...
          <div className="flex justify-between items-start">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-green-600">
                ...
                % distance and £
                {(
                  calculateRouteDistance(currentRoute) * 0.15 -
