        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className={`text-center mb-5 sm:mb-8 transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="mb-3 sm:mb-5">
              ...
              <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto mb-3 sm:mb-5 rounded-full"></div>
            </div>
            <h2 className="text-lg xs:text-xl sm:text-3xl md:text-5xl font-bold text-gray-800 mb-3 sm:mb-6 leading-tight px-2">
              Total Control from <span className="text-blue-600">Warehouse</span> to <span className="text-purple-600">Doorstep</span>
            </h2>
            <p className="text-sm xs:text-base sm:text-xl md:text-2xl text-gray-700 max-w-5xl mx-auto font-medium leading-relaxed mb-3 sm:mb-5 px-4">
          ...
          <div className={`transform transition-all duration-1000 delay-600 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 max-w-3xl mx-auto border border-blue-200 shadow-xl mb-8">
              ...
              <p className="text-gray-800 font-semibold italic text-center text-lg mb-4">"{testimonials[currentTestimonial].text}"</p>
