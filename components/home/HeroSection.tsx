      ...
      <section className="relative py-20 bg-gradient-to-br from-blue-50 via-white to-indigo-50 overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className={`text-center mb-8 sm:mb-16 transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-lg p-4 max-w-2xl mx-auto border border-blue-100 shadow-lg">
              <div className="flex items-center justify-center gap-2 mb-2">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="h-4 w-4 text-yellow-400 fill-current" />
                ))}
              </div>
              <p className="text-gray-700 font-medium italic">"{testimonials[currentTestimonial].text}"</p>
              <p className="text-sm text-gray-600 mt-2">— {testimonials[currentTestimonial].author}</p>
            </div>
          </div>

          {/* Enhanced CTAs */}
          <div className={`flex flex-col sm:flex-row gap-6 justify-center mb-12 transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <Button
              size="lg"
          ...
          <div className={`flex flex-wrap justify-center items-center gap-8 mb-16 transform transition-all duration-1000 delay-600 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="flex items-center gap-3 bg-white/90 backdrop-blur-sm rounded-full px-6 py-3 shadow-lg border border-green-200">
              ...
              <span className="font-bold text-green-700">Live in 48 hours</span>
            </div>
            <div className="flex items-center gap-3 bg-white/90 backdrop-blur-sm rounded-full px-6 py-3 shadow-lg border border-blue-200">
              ...
              <span className="font-bold text-blue-700">No training needed</span>
            </div>
            <div className="flex items-center gap-3 bg-white/90 backdrop-blur-sm rounded-full px-6 py-3 shadow-lg border border-purple-200">
              ...
              <span className="font-bold text-purple-700">UK support</span>
            </div>
          </div>

          {/* Enhanced Dashboard Teaser */}
          <div className={`mb-20 transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="text-center mb-8">
              <h3 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">See Your Command Center</h3>
              <p className="text-lg text-gray-600">Real-time visibility across your entire logistics operation</p>
              <div className="flex items-center justify-center gap-2 mt-3">
                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                <span className="text-sm text-green-600 font-semibold">Live Demo Data</span>
              </div>
            </div>
