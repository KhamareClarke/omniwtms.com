...
const UserSegmentationQuiz = dynamic(() => import("./UserSegmentationQuiz"), {
  ssr: false,
});
...
export default function PricingSection() {
  ...
  const featureGrid = [
    {
      name: "Real-Time Warehouse Dashboard",
      commander: true,
      fleetmaster: true,
      titan: true,
      icon: BarChart2,
      description: "Monitor warehouse activities in real-time",
    },
    {
    ...
    {
      name: "Driver Compliance Tracking",
      commander: true,
      fleetmaster: true,
      titan: true,
      icon: Shield,
    ...
    {
      name: "3D Floor Mapping",
      commander: false,
      fleetmaster: true,
      titan: true,
      icon: Building,
      description: "Visualize warehouse layout",
    },
    {
      ...
      titan: true,
      icon: Building2,
      description: "Centralized control for multiple sites",
    },
    {
    ...
    },
    {
      ...
      titan: true,
      icon: Zap,
      description: "Connect with other software",
    },
    {
      ...
      titan: true,
      icon: Users,
      description: "Customized mobile experience",
    },
    {
    ...
    },
    {
      ...
      titan: true,
      icon: Headphones,
      description: "Immediate assistance anytime",
    },
  ];
  ...
  const addons = [
    {
      name: "Pallet Mixer AI",
      price: "£299/mo",
      description: "Optimize pallet arrangements for maximum space utilization",
    },
    {
      name: "Advanced Analytics Module",
      price: "£199/mo",
      description: "Deep insights into operational efficiency and cost savings",
    },
    {
      name: "QuickBooks + Xero Integration",
      price: "£99/mo",
      description:
        "Seamlessly connect accounting systems for real-time financial data",
    },
    {
      name: "Priority Support",
      price: "£149/mo",
      description: "Dedicated support team with 4-hour response guarantee",
    },
    {
      name: "Custom API Development",
      price: "£399/mo",
      description: "Tailor-made integrations for your unique business systems",
    },
    {
      name: "Extended Team Training",
      price: "£249/mo",
      description:
        "Comprehensive monthly training for new staff and refreshers",
    },
  ];
  ...
  return (
    <div
      id="pricing"
      className="py-12 sm:py-16 md:py-24 relative bg-gradient-to-b from-white via-gray-50 to-white"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12">
          ...
          <p className="text-base sm:text-lg text-gray-600 px-3 sm:px-0">
            Choose the plan that scales with your business. All plans include
            24/7 support, regular updates, and data backup.
          </p>
        </div>
              ...
              >
                ...
                <div className="p-5 sm:p-6 md:p-8">
                  ...
                  <div className="text-center">
                    ...
                    <div className="mb-2">
                      <span className="text-2xl text-blue-600 sm:text-3xl font-bold">
                        {plan.price}
                      </span>
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-xs sm:text-sm font-bold text-center mb-3">
                      {plan.mainBenefit}
                    </p>
                    <ul className="space-y-2 sm:space-y-3">
                      {plan.includedHighlights.map((feature, idx) => (
                        <li
                          key={idx}
                          className="flex text-gray-800 items-start"
                        >
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  <th className="py-3 sm:py-4 px-3 sm:px-6 text-left text-xs sm:text-sm font-medium text-gray-700">
                    Feature
                  </th>
                  <th className="py-3 sm:py-4 px-3 sm:px-6 text-center text-xs sm:text-sm font-medium text-gray-700">
                    Commander
                  </th>
                  <th className="py-3 sm:py-4 px-3 sm:px-6 text-center text-xs sm:text-sm font-medium text-blue-600 border-x border-gray-200">
                    FleetMaster
                  </th>
                  <th className="py-3 sm:py-4 px-3 sm:px-6 text-center text-xs sm:text-sm font-medium text-gray-700">
                    Titan
              ...
              <tbody>
                {featureGrid.map((feature, index) => (
                  ...
                  >
                    <td className="py-3 sm:py-4 px-3 sm:px-6 text-xs sm:text-sm text-gray-800">
                      {feature.name}
                    </td>
                    <td className="py-3 sm:py-4 px-3 sm:px-6 text-center">
                      {feature.commander ? (
                        <Check className="h-4 sm:h-5 w-4 sm:w-5 text-green-500 mx-auto" />
                      ) : (
                        <X className="h-4 sm:h-5 w-4 sm:w-5 text-gray-300 mx-auto" />
                      )}
                    </td>
        ...
        <div className="grid grid-cols-1 text-blue-600 sm:grid-cols-3 gap-4 sm:gap-6 mb-12">
          <div className="bg-white rounded-xl shadow-md border border-gray-100 p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row sm:items-start">
              ...
              <div>
                <h3 className="font-bold text-base text-blue-600 sm:text-lg mb-1 sm:mb-2">
                  Save 60+ Hours/Month
                </h3>
                <p className="text-gray-600 text-xs sm:text-sm">
                  Eliminate manual admin tasks with smart automation
                </p>
              </div>
            </div>
          </div>

          <div className="bg-white text-blue-600 rounded-xl shadow-md border border-gray-100 p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row sm:items-start">
              <div className="bg-blue-100 p-3 rounded-lg mb-3 sm:mb-0 sm:mr-4 flex-shrink-0">
                <TrendingUp className="h-5 w-5 sm:h-6 sm:w-6 text-blue-600" />
              </div>
              <div>
                <h3 className="font-bold text-blue-600 text-base sm:text-lg mb-1 sm:mb-2">
                  3x More Orders Processed
                </h3>
                <p className="text-gray-600 text-xs sm:text-sm">
                  Without adding headcount to your team
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-100 p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row sm:items-start">
              ...
              <div>
                <h3 className="font-bold text-blue-600 text-base sm:text-lg mb-1 sm:mb-2">
                  Used by Large Warehouses
                </h3>
                <p className="text-gray-600 text-xs sm:text-sm">
                  Moving £10M+ per year in inventory
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 sm:mt-16 mb-8 sm:mb-10">
          <h3 className="text-xl text-blue-600 sm:text-2xl font-bold text-center mb-4 sm:mb-6">
            Not sure which plan? Let's figure it out together
          </h3>
        ...
        <div className="mt-8 sm:mt-10 text-center">
          <p className="text-gray-600 text-base sm:text-lg">
            Backed by logistics pros across the UK
          </p>
        </div>
          ...
          <div className="p-4 sm:p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              {addons.map((addon, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between border-b border-gray-100 py-3 sm:py-4"
                >
        ...
        <div className="mt-8 sm:mt-10 p-5 sm:p-8 bg-blue-50 rounded-xl border border-blue-100 text-center">
          <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">
            Want a custom quote for multiple warehouses?
          </h3>
