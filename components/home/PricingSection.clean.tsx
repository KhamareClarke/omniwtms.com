...
export default function PricingSection() {
  ...
  const plans = [
    {
      ...
      price: "£899",
      period: "/mo",
      altPrice: "or £9,599/year – save £1,189",
      description: "Best for: Small depots or courier firms",
      icon: Zap,
      features: [
      ...
      addons: [
        "+£0.60/delivery over limit",
        "+£15/user/month",
        "+£29/van/month for hardware tracking",
    ...
    },
    {
      ...
      price: "£1,499",
      period: "/mo",
      altPrice: "or £15,999/year – save £1,989",
      description:
        "Best for: Regional 3PLs, eCom fulfilment firms & B2B couriers",
      icon: Star,
      features: [
        ...
        "Label printing + customer alerts",
        "Inventory by bin/location",
        "API access",
        "Dedicated success manager",
        "Monthly logistics strategy review",
      ],
      addons: [
        "+£0.50/delivery over limit",
        "+£12/user/month",
    ...
    },
    {
      ...
      price: "From £2,499",
      period: "/mo",
      altPrice: "Custom annual pricing available",
      description:
        "Best for: National couriers, large 3PLs, enterprise eCom ops",
      icon: Crown,
      features: [
        "50,000+ deliveries/month",
        "Unlimited users + depots",
        ...
        "Logistics success team",
        "Custom integrations",
        "Full white-label options",
      ],
      addons: [],
      cta: "Book Demo",
      tailored: "Tailored setup for complex ops",
      popular: false,
    },
  ];
  ...
  const customPlan = {
    ...
    heading: "Custom Plans Available",
    price: "",
    period: "",
    description:
      "For micro ops or mega fleets — we'll build a package just for you.",
    features: [
      "Lower delivery volumes?",
      "Unique workflows?",
      "Extra integrations?",
    ],
    tagline: "Let's build your perfect plan.",
    cta: "Talk to Sales",
    ctaSuffix: "Scale your way",
  };
                ...
                {plan.discountedSlots && (
                  <div className="bg-amber-50 border border-amber-200 rounded-md px-3 py-2 mb-4 text-sm">
                    ...
                    <span className="text-amber-800">
                      Only {plan.discountedSlots} discounted slots left!
                    </span>
                  </div>
                )}
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <h3 className="text-2xl font-bold">{customPlan.heading}</h3>
                </div>
              </div>

              <p className="text-gray-700 mb-6">{customPlan.description}</p>
              ...
              <div className="flex flex-col space-y-2">
                ...
                <Button
                  onClick={handleOpenSignup}
                  className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white w-full px-6 py-2 rounded-md hover:from-purple-600 hover:to-indigo-700"
                >
                  {customPlan.cta}
                </Button>
                {customPlan.ctaSuffix && (
