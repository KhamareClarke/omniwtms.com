...
export function ProductsContent() {
  ...
  const handleAddProduct = async (
    productData: Omit<Product, "id" | "client_id" | "sku">
  ) => {
    if (!clientId) {
    ...
    try {
      ...
      reader.onload = async (e) => {
        ...
        if (processedProducts.length > 0) {
          ...
          toast.success(
            `Processed ${processedProducts.length} products. Please select categories and conditions.`,
            {
              id: loadingToast,
            }
          );
          ...
          toast.error(
            "No valid products found. Please check the file format.",
            {
              id: loadingToast,
            }
          );
    ...
    <div className="text-center py-12 px-4">
      <div className="max-w-md mx-auto">
        ...
        <p className="mt-2 text-sm text-gray-500">
          Get started by adding your first product or upload in bulk using
          Excel.
        </p>
